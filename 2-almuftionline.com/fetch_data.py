...
def get_question_detail(question):
    ...
    fatwa_number_ele = soup.select_one("div.entry-content.pagelayer-post-excerpt figure.wp-block-table > table tr:nth-child(1) > td:nth-child(1)")
    ...
    if fatwa_number_ele:
        fatwa_number = fatwa_number_ele.get_text().strip()
    ...
    content_ele = soup.select_one("div.entry-content.pagelayer-post-excerpt > h6.has-text-align-right")

    if content_ele:
        answer_html += str(content_ele)
        paras = content_ele.find_next_siblings()
...
# Patches: 455-755, 755-1055, 1055-1255, 1255-1484
...
for page_number in range(start_page, total_pages + 1):
    ...
    for index, question in enumerate(questions, 1):
        ...
        data_rows.append({
            ...
            "fatwa_number":  content["fatwa_number"] or question["fatwa_number"],
